...
public static class OpenIddictUIInfrastructureServicesExtensions
{
    ...
    )
    {
        ...
        services.AddTransient<IOpenIddictApplicationClaimRepository, OpenIddictApplicationClaimRepository<OpenIddictUIContext>>();

        services.AddTransient<IScopeService, ScopeService>();
        services.AddTransient<IApplicationService, ApplicationService>();
        services.AddTransient<IOpenIddictApplicationClaimService, OpenIddictApplicationClaimService>();
